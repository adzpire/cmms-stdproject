...
<div class="book-manage-type-form">

    <?php $form = ActiveForm::begin([
			'layout' => 'horizontal', 
			'id' => 'book-manage-type-form',
			//'fieldConfig' => [
    ...
    <?= $form->field($model, 'bmt_code')->textInput(['maxlength' => true]) ?>

    <?= $form->field($model, 'bmt_nameTh')->textInput(['maxlength' => true]) ?>

    <?= $form->field($model, 'bmt_nameEng')->textInput(['maxlength' => true]) ?>
